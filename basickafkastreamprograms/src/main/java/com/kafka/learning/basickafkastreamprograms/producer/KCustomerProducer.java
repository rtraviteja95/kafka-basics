...
public class KCustomerProducer {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		KCustomerProducer kCustomerProducer = new KCustomerProducer();

		for(Customer customer: customers) {
			kCustomerProducer.sendRecord("customer.topic.test", customer.getCustomerId(), customer);
		}
	}

	private static Producer<Integer, Customer> producer = null;

	public KCustomerProducer(){
	...
	public void sendRecord(String topic, int key, Customer value) throws InterruptedException, ExecutionException{

		ProducerRecord<Integer, Customer> record = new ProducerRecord<Integer, Customer>(topic, key, value);

		KCustomerProducer.producer.send(record, new Callback() {
